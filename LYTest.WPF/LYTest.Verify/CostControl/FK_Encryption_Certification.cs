...
namespace LYTest.Verify.CostControl
{
    ...
    /// 身份认证
    /// </summary>
    public class FK_Encryption_Certification : VerifyBase
    {
        /// <summary>
        /// 重写基类测试方法
        /// </summary>
        ...
        public override void Verify()
        {
            ...
            {
                //if (App.MethodAndBasic.Replace485)
                //    SwitchChannel(Cus_ChannelType.通讯载波);

                if (Stop) return;
                MessageAdd("正在身份认证", EnumLogType.提示信息);
            ...
            //add yjt 20220305 新增日志提示
            MessageAdd("身份认证试验检定结束...", EnumLogType.流程信息);
        }
