...
namespace LYTest.Mis.IMICP.IMICPDataTables
{
    ...
    /// 电能表误差一致性试验
    /// </summary>
    public class VConsistMeterConc : CommonDatas_DETedTestData
	{
		...
		public string allError { get; set; }    //	误差
		public string intConvertErr { get; set; }   //	化整误差
		public string allAvgError { get; set; } //	所有表位平均误差
		public string allIntError { get; set; } //	所有表位化整值平均误差
		...
		public string testAvgErr { get; set; }  //	误差平均
