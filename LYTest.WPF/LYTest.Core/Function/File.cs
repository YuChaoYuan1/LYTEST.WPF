...
//        /// <returns></returns>
//        public static bool WriteTXT(string strFileName, string strs)
//        {
//            try
//            {
//                string LogPath = string.Format(@"ErrLog\{0}.txt", strFileName);
//                LogPath =Function.File.GetPhyPath(LogPath);
//                FileStream Fs = Function.File.Create(LogPath);
//                if (Fs == null)
//                {
...
//{0}:{1}
//    {2}
//    ", DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss"), " ", strs);
