...

{
    ...
    /// 标准表联机/脱机请求包
    /// </summary>
    internal class ZHzd_RequestLinkPacket : ZH3001SendPacket
    {
        public bool IsLink = true;

        public ZHzd_RequestLinkPacket()
            : base()
        { }
    ...
    /// 多功能板，联机返回指令
    /// </summary>
    internal class ZHzd_RequestLinkReplyPacket : ZH3001RecvPacket
    {
        protected override void ParseBody(byte[] data)
        {
    ...
    /// 多功能板联机/脱机请求包
    /// </summary>
    internal class ZHzd_RequestContonlRelayPacket : ZH3001SendPacket
    {
        public byte _byteID = new byte(); //ID
        public byte _byteRelayType = new byte();// 继电器状态
        //       发送：68H+RID+SID+LEN+13H+8800H+DATA+CS  （DATA=2bytes）
        ...
        public ZHzd_RequestContonlRelayPacket()
            : base()
        { }
    ...
    /// 多功能板，联机返回指令
    /// </summary>
    internal class ZHzd_RequesttContonlRelayReplyPacket : ZH3001RecvPacket
    {
        /// <summary>
        /// 获取源信息
        /// </summary>
    ...
    /// 请求包
    /// </summary>
    internal class ZH_Contonl12Packet : ZH3001SendPacket
    {
        //       发送：68 FF FE 14 13 50 00 00 00 2E E0 00 00 FF FF FF FF FF FF 98
        private byte[] data = new byte[] { 0x00, 0x00, 0x2E, 0xE0, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
        public ZH_Contonl12Packet()
            : base()
        { }

        public void SetPara(int id, int relayType)
        {
            ToID = Convert.ToByte(id);
        }
        protected override byte[] GetBody()
        {
            ByteBuffer buf = new ByteBuffer();
    ...
    /// 多功能板，联机返回指令
    /// </summary>
    internal class ZH_Contonl12ReplyPacket : ZH3001RecvPacket
    {
        public override bool ParsePacket(byte[] data)
        {
            bool resul = false;
