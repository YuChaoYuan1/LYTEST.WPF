...
namespace ZH
{
    ...
    internal abstract class ZHRecvPacket_CLT11 : RecvPacket
    {
        ...
        public override bool ParsePacket(byte[] buf)
        {
            ...
            ushort dataLength = pack.GetUShort_S();
            if (buf.Length < dataLength || dataLength<5) return false;
            byte[] data = pack.GetByteArray(dataLength - 6);
    ...
    internal abstract class ZHSendPacket_CLT11 : SendPacket
    {
        ...
        /// 发信节点
        /// </summary>
        public byte MyID = 0x01;
        /// <summary>
        /// 受信节点
        /// </summary>
        protected byte ToID = 0x01;
        ...
        public override byte[] GetPacketData()
        {
            ...
            if (body == null)
                return null;
            ushort packetLength = (ushort)(body.Length + 6);//帧头4字节+CS一字节           
            buf.PutUShort(packetLength);      //帧长度
            buf.Put(body);              //数据域 
        ...
        /// <param name="bytData"></param>
        /// <returns></returns>
        protected ushort GetChkSumUshort(byte[] bytData)
        {
            ushort bytChkSum = 0x00;
            for (int int_Inc = 1; int_Inc < bytData.Length; int_Inc++)
            {
                bytChkSum ^= bytData[int_Inc];
            }
    ...
    /// 376X协议发送包基类
    /// </summary>
    internal abstract class QGDW376SendPacket : SendPacket
    {
        /// <summary>
        /// 包头
        /// </summary>
    ...
    internal abstract class QGDW376RecvPacket : RecvPacket
    {
        /// <summary>
        /// 包头
        /// </summary>
    ...
    /// 其数据长度为 1 字节
    /// </summary>
    internal abstract class ZHRecvPacket_NotCltOne : ZHRecvPacket_NotCtl
    {
    ...
    /// 默认需要回复
    /// </summary>
    internal abstract class ZHSendPacket_NotCltOne : ZHSendPacket_NotClt
    {
        /// <summary>
        /// 已重写，
        ...
        public ZHSendPacket_NotCltOne(bool isNeedReturn)
        ...
        public ZHSendPacket_NotCltOne(bool isNeedReturn, byte toID)
        {
    ...
    /// 
    /// </summary>
    internal abstract class ZHRecvPacket_NotCltTwo : ZHRecvPacket_NotCtl
    {
        protected override byte FrameLengthByteCount
        {
            get { return 2; }
    ...
    /// 
    /// </summary>
    internal abstract class ZHSendPacket_NotCltTwo : ZHSendPacket_NotClt
    {
        /// <summary>
        /// 已重写，返回 2
        /// </summary>
        ...
        /// </summary>
        /// <param name="isNeedReturn"></param>
        public ZHSendPacket_NotCltTwo(bool isNeedReturn)
            : this(isNeedReturn, 0x00)
        {
        }
        ...
        /// <param name="isNeedReturn">该包是否需要返回</param>
        /// <param name="toID">目标ID</param>
        public ZHSendPacket_NotCltTwo(bool isNeedReturn, byte toID)
        {
            this.IsNeedReturn = isNeedReturn;
            this.ToID = toID;
        }
    ...
    /// 非CLT1.1
    /// </summary>
    internal abstract class ZHRecvPacket_NotCtl : RecvPacket
    {
        /// <summary>
        /// 包头
        /// </summary>
    ...
    /// 默认需要回复
    /// </summary>
    internal abstract class ZHSendPacket_NotClt : SendPacket
    {
        /// <summary>
        /// 包头
        /// </summary>
    ...
    /// 直接接收基类
    /// </summary>
    internal abstract class RecvPacket_Nothing : RecvPacket
    {
    ...
    /// 默认需要回复
    /// </summary>
    internal abstract class SendPacket_Nothing : SendPacket
    {
