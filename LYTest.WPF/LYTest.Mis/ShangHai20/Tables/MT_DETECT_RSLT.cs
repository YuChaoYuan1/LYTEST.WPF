namespace LYTest.Mis.ShangHai20.Tables
{
    public class MT_DETECT_RSLT : MT_MET_CONC_Base
    {
        ...
        /// INIERR_CONC_CODE
        /// </summary>
        public string INIERR_CONC_CODE { get; set; }
