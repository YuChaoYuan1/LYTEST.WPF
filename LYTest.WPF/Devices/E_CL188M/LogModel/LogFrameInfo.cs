...
namespace CLOU.LogModel
{
    ...
    public class LogFrameInfo
    {
        ...
        /// 发帧结构
        /// </summary>
        public Struct.StSRFrame SendFrm { get; set; } = new Struct.StSRFrame();
        /// <summary>
        /// 收帧结构
        /// </summary>
        public Struct.StSRFrame ResvFrm { get; set; } = new Struct.StSRFrame();
        /// <summary>
        /// 备用
        /// </summary>
        ...
        {
            return string.Format("'{0}','{1}','{2}','{3}',{4},{5},'{6}'", PortNo, EquipName, ItemName, Message, SendFrm.ToString(), ResvFrm.ToString(), Other);
        }
