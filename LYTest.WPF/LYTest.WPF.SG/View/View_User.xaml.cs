...
namespace LYTest.WPF.SG.View
{
    ...
    public partial class View_User : IDisposable
    {
        ...
        private void NavigateToCurrrentPage()
        {
            ...
            {
                case 0:
                    frameUser.Source = new Uri("/LYTest.WPF.SG;component/User/Page_LoginUser.xaml", UriKind.Relative);
                    break;
                case 1:
                    frameUser.Source = new Uri("/LYTest.WPF.SG;component/User/Page_MainUser.xaml", UriKind.Relative);
                    break;
                case 2:
                    frameUser.Source = new Uri("/LYTest.WPF.SG;component/User/Page_PassWordChange.xaml", UriKind.Relative);
                    break;
                case 3:
                    frameUser.Source = new Uri("/LYTest.WPF.SG;component/User/Page_DelUser.xaml", UriKind.Relative);
                    break;
                case 4:
                    frameUser.Source = new Uri("/LYTest.WPF.SG;component/User/Page_AddUser.xaml", UriKind.Relative);
                    break;
            }
        }
